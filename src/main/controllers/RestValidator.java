...
public class RestValidator {
	...
	public RestValidator expectNumberOfUsers(int expectedNumbers) {
		Assert.assertEquals("Incorrect Numbers of Contacts", expectedNumbers, response.getNumberOfUsers());
		return this;
	}
	...
	public RestValidator expectInBody(String content) {
		Assert.assertTrue("Body doesn't contain string : " + content, response.getResponseBody().contains(content));
		return this;
	}
